/* 1. Write a program that parses the following log messages into a JSON object and prints the JSON out.  Timestamp should be converted to time since epoch (assume timestamps are UTC).
Log messages:
